...
public class Q1SumDeptSalary extends Configured implements Tool{
	...
	public static Logger log = LoggerFactory.getLogger(Q1SumDeptSalary.class);
	...
	public static void main(String[] args) {
		...
		//run job
		try {
			int status = ToolRunner.run(configuration, new Q1SumDeptSalary(), args);
			System.exit(status);
		} catch (Exception e) {
			e.printStackTrace();
		}
